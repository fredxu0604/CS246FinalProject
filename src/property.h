...
const map<string, Group> propertyGroupMap = {
    {"AL", Group::Arts1},   {"ML", Group::Arts1},   {"ECH", Group::Arts2},
    {"PAS", Group::Arts2},  {"HH", Group::Arts2},   {"RCH", Group::Eng},
    {"DWE", Group::Eng},    {"CPH", Group::Eng},    {"LHI", Group::Health},
    {"BMH", Group::Health}, {"OPT", Group::Health}, {"EV1", Group::Env},
    {"EV2", Group::Env},    {"EV3", Group::Env},    {"PHYS", Group::Sci1},
    {"B1", Group::Sci1},    {"B2", Group::Sci1},    {"EIT", Group::Sci2},
    {"ESC", Group::Sci2},   {"C2", Group::Sci2},    {"MC", Group::Math},
    {"DC", Group::Math}};
...
const map<std::string, PropertyType> residenceGymMapByNames{
    {"PAC", PropertyType::Gym},       {"CIF", PropertyType::Gym},
    {"MKV", PropertyType::Residence}, {"UWP", PropertyType::Residence},
    {"V1", PropertyType::Residence},  {"REV", PropertyType::Residence}};

const map<int, size_t> residenceRentMap = {
    {1, 25}, {2, 50}, {3, 100}, {4, 200}};

const map<string, size_t> purchaseCostMap = {
    {"AL", 40},   {"ML", 60},   {"ECH", 100}, {"PAS", 100}, {"HH", 120},
    {"RCH", 140}, {"DWE", 140}, {"CPH", 160}, {"LHI", 180}, {"BMH", 180},
    {"OPT", 200}, {"EV1", 220}, {"EV2", 220}, {"EV3", 240}, {"PHYS", 260},
    {"B1", 260},  {"B2", 280},  {"EIT", 300}, {"ESC", 300}, {"C2", 320},
...
const std::vector<std::string> allOwnableProperties{
    "AL",  "ML",  "ECH", "PAS", "HH",   "RCH", "DWE", "CPH", "LHI", "BMH",
    "OPT", "EV1", "EV2", "EV3", "PHYS", "B1",  "B2",  "EIT", "ESC", "C2",
    "MC",  "DC",  "MKV", "UWP", "V1",   "REV", "PAC", "CIF"};
